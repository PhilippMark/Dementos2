<%@ Page Title="" Language="C#" MasterPageFile="~/OrganizeMonkey.Master" AutoEventWireup="true" CodeBehind="Impressum.aspx.cs" Inherits="OrganizeMonkey.Impressum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <div class="jumbotron"> 
    <img style="margin-left:43%" src='<%= ResolveUrl("~/styles/MonkeyBrille.png") %>' alt="Logo" class="img-circle" width="10%"/>
    <br />
    <h1>Impressum</h1> <h2>Angaben gem&auml;&szlig; &sect; 5 TMG:</h2> <p>Philipp Markendorf<br />
Flemingstra&szlig;e 11<br /><br /> 10557 Berlin</p> <h2>Kontakt:</h2> <p>Telefon: 01626236632<br />
E-Mail: philmark@online.de</p> <h2>Haftung f&uuml;r Inhalte</h2> <p>Als Diensteanbieter sind wir
...
Kontaktformular</h2> <p>Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre
...
geben wir nicht ohne Ihre Einwilligung weiter.</p><p>&nbsp;</p> <h2>Kommentarfunktion auf dieser
Webseite</h2> <p>F&uuml;r die Kommentarfunktion auf dieser Seite werden neben Ihrem Kommentar
auch Angaben zum Zeitpunkt der Erstellung des Kommentars und, wenn Sie nicht anonym posten, der
von Ihnen gew&auml;hlte Nutzername gespeichert.</p> <p>&nbsp;</p> <p>Quelle: <a
